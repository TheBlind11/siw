...
public class PersonaController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) 
		...
		mappaErrori.put("ErroreNome", "Errore, nome non inserito correttamente!");
		mappaErrori.put("ErroreCognome", "Errore, cognome non inserito correttamente!");
		...
		if (pv.valid(request, mappaErrori)) {
